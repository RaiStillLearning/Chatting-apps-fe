        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="aspect-square w-full bg-gray-200 dark:bg-gray-800 rounded-xl flex flex-col items-center justify-center text-center gap-2 transition-all hover:scale-105 hover:shadow-lg p-4 text-xs sm:text-sm">
              ...
              <p>
                Engage in privaet and group conversations instantly, Sharing
                your thoughts and experiences seamlessly.
              </p>
            </div>
            ...
            <div className="aspect-square w-full bg-gray-200 dark:bg-gray-800 rounded-xl flex flex-col items-center justify-center text-center gap-2 transition-all hover:scale-105 hover:shadow-lg p-4 text-xs sm:text-sm">
              ...
              <p>
                Share your photos and videos with friends and followers,
                capturing and preserving your favorite moments.
              </p>
            </div>
            ...
            <div className="aspect-square w-full bg-gray-200 dark:bg-gray-800 rounded-xl flex flex-col items-center justify-center text-center gap-2 transition-all hover:scale-105 hover:shadow-lg p-4 text-xs sm:text-sm">
              ...
              <h2>
                <b>Show Appreciation</b>
              </h2>
              <p>
                Express your admiration for posts and comments with likes,
            ...
            <div className="aspect-square w-full bg-gray-200 dark:bg-gray-800 rounded-xl flex flex-col items-center justify-center text-center gap-2 transition-all hover:scale-105 hover:shadow-lg p-4 text-xs sm:text-sm">
              ...
              <p>
                Receive instant updates on new messages, likes, and followers,
